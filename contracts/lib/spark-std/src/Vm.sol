...
interface VmSafe {
    ...
    // Signs data
    function sign(string calldata privateKey, bytes32 digest) external pure returns (bytes memory sig);
    ...
    // 0xce8147e798c3a0d867f70f8785334da06c3418e18ba9 for private network,
