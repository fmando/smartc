# Spark Standard Library • [![CI status](https://github.com/bchainhub/spark-std/actions/workflows/ci.yml/badge.svg)](https://github.com/bchainhub/spark-std/actions/workflows/ci.yml)
...
**Learn how to use spark-std with the [📖 Foxar Book (spark-std Guide)](https://book.getfoxar.sh/spark/spark-std.html).**
